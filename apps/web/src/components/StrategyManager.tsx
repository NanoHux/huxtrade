...
const restingDefaults:RestingEntrySettings={
  ...
  scaleOutTriggerR:0.5,scaleOutFraction:0.5,scaleOutMinStopPercent:0.8,breakevenOffsetR:0.05,minStopSpreadMultiple:4,structuralRejectionLimit:3,structuralBackoffHours:6
};
